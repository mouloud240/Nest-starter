...
Login bypasses Passport because GraphQL requests do not populate `req.body` the way REST does. The resolver validates the user directly and writes the session.
